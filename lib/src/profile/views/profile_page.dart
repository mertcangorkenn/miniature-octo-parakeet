                ...
                return Container(
                  ...
                  child: Hero(
                    ...
                    child: ModelViewer(
                      ...
                      alt: "Kullanıcı avatarının 3B modeli",
                      ar: true,
                    ),
                  ),
                );
                ...
                return Container(
                  ...
                  child: ListView(
                    ...
                    children: [
                      ...
                      Obx(
                        () => Text(
                          _userController.user.name ?? "Selamlar",
                      ...
                      Obx(
                        () => Text(
                          _userController.user.bio ??
                              "Google ile giriş yaparak Kuran okurken favori oluşturup tekrar okuyabilirsiniz.",
                      ...
                      ProfileItem(
                        ...
                        onPressed: () {
                          Share.share(
                            "Kuranı Kerim ve Kapsamlı İslâm Uygulamasını kullanıyorum, tavsiye ederim. https://play.google.com/store/apps/details?id=com.kuran.mealii",
                            subject: "Kuran Meali",
                          );
                        },
                      ),
